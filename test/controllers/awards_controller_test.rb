...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { avatar: @award.avatar, description: @award.description, merchant_id: @award.merchant_id, name: @award.name, status: @award.status, user_id: @award.user_id } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { avatar: @award.avatar, description: @award.description, merchant_id: @award.merchant_id, name: @award.name, status: @award.status, user_id: @award.user_id } }
